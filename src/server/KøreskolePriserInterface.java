...
public interface KøreskolePriserInterface extends java.rmi.Remote {
	...
	void sletKøreskole(String adminBrugernavn, String adminKodeord, String køreskole_id) 						throws java.rmi.RemoteException;
	void sletKøreskoleTilbud(String adminBrugernavn, String adminKodeord, int tilbud_id )						throws java.rmi.RemoteException;
